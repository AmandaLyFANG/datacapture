    ...
    try:
        ...
        if individual_criteria:
            individual_criteria_dict = {
                ...
                "Customer_service": individual_criteria[3].find_element(By.TAG_NAME, "span").get_attribute("class")[-2],
                "Value_for_money": individual_criteria[4].find_element(By.TAG_NAME, "span").get_attribute("class")[-2],
                ...
                "Food_and_Beverage": individual_criteria[7].find_element(By.TAG_NAME, "span").get_attribute("class")[-2]
            }
